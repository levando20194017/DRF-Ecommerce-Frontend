                ...
                <div className=''>
                    ...
                    <div className='shipping-address'>
                        ...
                        <div>
                            ...
                            <span className='ms-3'><Button className = "btn-change">Thay đổi</Button></span>
                        </div>
                    </div>
                    ...
                    <div className='total-cost mt-1'>
                        ...
                        <div className='payment-action'>
                            <div>Nhấn đặt hàng đồng nghĩa với việc bạn đồng ý điều khoản tuân theo <a>Điều khoản Viva Phone</a></div>
                        </div>
                    </div>
                </div>
