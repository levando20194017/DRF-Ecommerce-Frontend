...
const NotFound = () => {
  return (
    <main>
      <div className="d-flex justify-content-center align-items-center" style={{ height: "100vh", color: "#fff" }}>
        <div className="row">
            ...
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
              ...
              <g>
                ...
                <g id="planet">
                  ...
                  <circle id="craterBig" fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="548.891"
                    cy="62.319" r="13.074" />

                  <circle id="craterSmall" fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10"
                    cx="591.743" cy="158.918" r="7.989" />
                  <path id="ring" fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                    stroke-miterlimit="10" d="
                  M476.562,101.461c-30.404,2.164-49.691,4.221-49.691,8.007c0,6.853,63.166,12.408,141.085,12.408s141.085-5.555,141.085-12.408
                  c0-3.378-15.347-4.988-40.243-7.225" />

                  <path id="ringShadow" opacity="0.5" fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                    stroke-miterlimit="10" d="
                ...
                <g id="stars">
                  <g id="starsBig">
                    <g>
                      ...
                      <line fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                ...
                <g id="spaceman" clip-path="url(cordClip)">
                  <path id="cord" fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                  ...
                  <g id="head">
                    ...
                    <path id="headStripe" fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                      stroke-linejoin="round" stroke-miterlimit="10" d="
                    ...
                    <g clip-path="url(#GlassClip)">
                      <polygon id="glassShine" fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10"
                        points="
          ...
          <div className="col-md-6 align-self-center">
            ...
            <Link to={Routes.HomePage.path}>
              <button className="btn btn-primary" style={{ width: "150px" }}>HOME</button>
            </Link>
          </div>
        </div>
      </div>
